...
class Product {
  ...
  constructor(productDetails){ // converting a object into a class;
...
// INHERITANCE is used when one class is a more specific type of another class; and lets us reuse code between classes;
class Clothing extends Product{ 
  sizeChartLink;

  constructor(productDetails){
    super(productDetails); // 'super' gets the constructor from 'Product' and "put" into this constructor; 
...
export function loadProductsFetch(){
  ...
  }).catch((error) => { // catch executes when a error occurs
